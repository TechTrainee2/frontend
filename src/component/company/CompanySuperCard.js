        ...
        <>
         <div className='uni-sup-std-info-svg'>
              ...
              <div className='svg-container'>
                ...
                <div className='svg-txt'>
                        <svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" onClick={handelOnClickEditYes}>
                    ...
                    <div className='svg-txt'>
                        <svg width={40} height={40} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" onClick={handelOnClickDeleteYes}>
...
<div className='reg-std-info-comp width-90'>
                ...
                <div className='uni-std-report-info'>
                    <input type='text'placeholder='Ahmad ' className='reg-input-edit-super font-med light-blue-bk'/>
                    <input type='text' placeholder='react developer ' className='reg-input-edit-super font-med light-blue-bk'/>
                </div>    
