...
function CardSuperProfEdit() {
        let [inputValue, setInputValue] = useState('Works at the University of Jordan in the Computer Science department');
        ...
        <div className='std-acc-comp'>
            ...
            <div className='std-images'>
                ...
                <div className='std-profile'>
                    <img src={img2} className='std-circle'/>
