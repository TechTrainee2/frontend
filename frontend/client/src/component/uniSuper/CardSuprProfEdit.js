...
function CardSuperProfEdit(props) {
    ...
    <>
     <div className='large-card gray-bk centered-card'>
        ...
        <div className='std-acc-comp'>
            ...
            <img src={props.selectedImage2Url ? props.selectedImage2Url : props.profile.img_bk} name='img_bk' className='imgbk-size'/>
                    <div className='svg-circle-cover'>
                        <label>
                            <input type='file' accept='image/*'  name='img_bk'className='display-img' onChange={props.onImage2Change}/>                    
                ...
                <img src={props.selectedImage1Url ? props.selectedImage1Url : props.profile.img} name='img' className='std-circle'/>

                    <div className='svg-circle'>
                        <label>
                            <input type='file' accept='image/*' name='img' className='display-img' onChange={props.onImage1Change}/>                    
...
export default CardSuperProfEdit