...
function CardStdReport(props) {
    ...
    let [selectedPdf, setSelectedPdf] = useState(null);
...
<>
    <div className='compsuper-std-report-cont'>
        <div className='compsuper-std-name-cont'>
            <Link to= {`/stdAcc/${props.report.student}`}>
                    <img src={props.profile.img} className='uni-std-circle'/>
            </Link>
                    <div className='compsuper-std-name'>
            <Link to= {`/stdAcc/${props.report.student}`}>
                        <span> {props.extradt.first_name} {props.extradt.last_name}'s Report</span>
            </Link>
                    </div>
        </div>
    </div>
                ...
                <div className='uni-super-upload-sign-box '>
                    <div className='reg-add-std-box-comp' onClick={handelOnClickAddNo}>
                        ...
                        <div className='reg-upload-comp'>
                            ...
                            <button className='reg-button-size navy-bk white-font' type='submit' >Done</button>
                        </div>
                        </form>
