...
function NavbarStd3(props) {
  return (
    <>
    <div className='nav-std'>
        <Link to ='/stdHome'  className='not-clicked'>
        ...
        <div className='icon-cont'>
            <div className='icons'>
                ...
                <Link to ={`/stdAcc/${props.id}`}  className='not-clicked'>
            ...
            <div className='icons'>
                <Link to ={`/stdReport/${props.id}`} className='not-clicked'>
            ...
            <div className='icons'>
                <Link to ='/studentApplications' className='not-clicked'>
