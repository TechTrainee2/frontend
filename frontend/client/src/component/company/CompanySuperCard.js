...
function CompanySuperCard(props) {
    let [isModal,setIsModal]=useState(false) 
        ...
        try {
            const res2 = await fetch(`http://127.0.0.1:8000/users/user/compsuper/assign/company/${props.CompSupervisor.user}`, {
                method: "PATCH",
                headers: {
         ...
         <div className='uni-sup-std-info-svg'>
              ...
              <div className='svg-container'>
                <div className='svg-txt'>
                    <Link to={`/assignCompSuper/${props.CompSupervisor.company_supervisor.user}`}>
                ...
                <div className='svg-txt'>
                <Link to={`/EditCompSuper/${props.CompSupervisor.company_supervisor.user}`}>
